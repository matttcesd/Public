...
foreach ($user in $notifyUsers)
{
    ...
    <p> To change your password, on a Sokol Blosser PC, press 'CTRL + ALT + Delete' on your keyboard and choose 'Change Password'. <br>
    <p> Don't forget to update the password on your mobile devices as well!
    <p>Thanks, <br> 
    </P>
    IT Support
    <a href=""mailto:support@cnwi.net""?Subject=Password Expiry Assistance"">support@cnwi.net</a> | (503)906-8700
    </font>"
